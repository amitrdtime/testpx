 ...
 *   description: API for managing SOWs
 */
...
router.post('/:clientid/sow', sowController.createSow);

/**
 * @swagger
 * /client/{clientid}/sow/{sowid}:
 *   patch:
...
router.patch('/:clientid/sow/:sowid', sowController.updateSow);

/**
 * @swagger
 *  /client/{clientid}/sows:
 *   get:
...
router.get('/:clientid/sows', sowController.getSows);
...
router.get('/:clientid/sow/:sowid', sowController.getSowByClientIdSowId);
