 ...
 *     tags: 
 *       - Clients
 *     description: Update the details of an existing client record. Supports conditional updates using the If-Match header with @odata.etag, which can be obtained from the Get API response object.
 *     parameters:
 *       - name: id
 *         in: path
 *         required: true
...
router.patch('/:id', clientController.updateCustomer);
...
router.get('/', clientController.getCustomers);
...
router.get('/:id', clientController.getCustomerById);
